...
namespace JohnStriker.ParticleExplosion
{
    public class Projectile
    {
        ...
        public bool Update(GameTime gameTime)
        {
           ...
           // trailEmitter.Update(gameTime, _position);
            ...
            if (age > projectileLifespan)
            {
                for (int i = 0; i < numExplosionParticles; i++)
                    explosionParticles.AddParticle(_position, velocity);

                for (int i = 0; i < numExplosionSmokeParticles; i++)
                    explosionSmokeParticles.AddParticle(_position, velocity);
