...
namespace JohnStriker.Graphics
{
    public class BlurManager :IDisposable
    {
        ...
        public void RenderScreenQuad(GraphicsDevice graphicsDevice, BlurTechnique blurTechnique, Texture2D texture,
            Vector4 colorVector4, float scale)
        {
            ...
            blurEffect.CurrentTechnique = blurEffect.Techniques[(int)blurTechnique];
            ...
            paramPixelSize.SetValue(pixelSize);
            paramColorMap.SetValue(texture);
            paramColor.SetValue(colorVector4);
